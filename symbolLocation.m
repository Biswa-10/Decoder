...
%{
The function symbolLocation takes in an target symbol and a list of of
symbol read from the text

It then searches the list for the target symbol and returns the location of
the symbol 
